...
import logoImage from "../../Images/logo.JPG"; // Adjust the relative path accordingly




function UpdatePatient({ handleLogin, handleArrowButtonClick }) {
  ...
  // const getMenuIconChange = () => {
  //   return isSidebarOpen ? (
  //     <BxMenu className="icon" onClick={toggleSidebar} />
  //   ) : (
  //     <BxCancel className="icon" onClick={toggleSidebar} />
  //   );
  // };
